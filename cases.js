...
const CASES = [
  ...
  /* ---------- FOOD & BEVERAGE ---------- */
  {
    ...
    figures: [
      { src: "assets/yafa-grid-1.jpg", caption: "Yafa — Instagram grid, Palestinian heritage series" },
      { src: "assets/yafa-grid-2.jpg", caption: "Yafa — content grid 2" },
      { src: "assets/yafa-grid-3.jpg", caption: "Yafa — content grid 3" },
      { src: "assets/yafa-grid-4.jpg", caption: "Yafa — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/hathout-grid-1.jpg", caption: "Eid campaign grid — reach per post, peaking at 467K" },
      { src: "assets/hathout-grid-2.jpg", caption: "Summer campaign grid — new branch reveal reached 773K" },
      { src: "assets/hathout-grid-3.jpg", caption: "Hathout — content grid 3" },
      { src: "assets/hathout-grid-4.jpg", caption: "Hathout — content grid 4" }
    ],
    links: [
...

  {
    ...
    figures: [
      { src: "assets/coffee-wizard-grid-1.jpg", caption: "Coffee Wizard — content grid 1" },
      { src: "assets/coffee-wizard-grid-2.jpg", caption: "Coffee Wizard — content grid 2" },
      { src: "assets/coffee-wizard-grid-3.jpg", caption: "Coffee Wizard — content grid 3" },
      { src: "assets/coffee-wizard-grid-4.jpg", caption: "Coffee Wizard — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/sharqi-grid-1.jpg", caption: "Sharqi — content grid 1" },
      { src: "assets/sharqi-grid-2.jpg", caption: "Sharqi — content grid 2" },
      { src: "assets/sharqi-grid-3.jpg", caption: "Sharqi — content grid 3" },
      { src: "assets/sharqi-grid-4.jpg", caption: "Sharqi — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/mac-n-pie-grid-1.jpg", caption: "Mac 'N' Pie — content grid 1" },
      { src: "assets/mac-n-pie-grid-2.jpg", caption: "Mac 'N' Pie — content grid 2" },
      { src: "assets/mac-n-pie-grid-3.jpg", caption: "Mac 'N' Pie — content grid 3" },
      { src: "assets/mac-n-pie-grid-4.jpg", caption: "Mac 'N' Pie — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/hamdy-shalaby-rest-grid-1.jpg", caption: "Hamdy Shalaby Restaurant — content grid 1" },
      { src: "assets/hamdy-shalaby-rest-grid-2.jpg", caption: "Hamdy Shalaby Restaurant — content grid 2" },
      { src: "assets/hamdy-shalaby-rest-grid-3.jpg", caption: "Hamdy Shalaby Restaurant — content grid 3" },
      { src: "assets/hamdy-shalaby-rest-grid-4.jpg", caption: "Hamdy Shalaby Restaurant — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/hamdy-shalaby-butchery-grid-1.jpg", caption: "Hamdy Shalaby Butchery — content grid 1" },
      { src: "assets/hamdy-shalaby-butchery-grid-2.jpg", caption: "Hamdy Shalaby Butchery — content grid 2" },
      { src: "assets/hamdy-shalaby-butchery-grid-3.jpg", caption: "Hamdy Shalaby Butchery — content grid 3" },
      { src: "assets/hamdy-shalaby-butchery-grid-4.jpg", caption: "Hamdy Shalaby Butchery — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/cairo-eats-grid-1.jpg", caption: "Cairo Eats — content grid 1" },
      { src: "assets/cairo-eats-grid-2.jpg", caption: "Cairo Eats — content grid 2" },
      { src: "assets/cairo-eats-grid-3.jpg", caption: "Cairo Eats — content grid 3" },
      { src: "assets/cairo-eats-grid-4.jpg", caption: "Cairo Eats — content grid 4" }
    ],
  ...
  /* ---------- BEAUTY & SKINCARE ---------- */
  {
    ...
    figures: [
      { src: "assets/upcellro-grid-1.jpg", caption: "UPCELLRO® — launch grid, full awareness rollout" },
      { src: "assets/upcellro-grid-2.jpg", caption: "UPCELLRO® — content grid 2" },
      { src: "assets/upcellro-grid-3.jpg", caption: "UPCELLRO® — content grid 3" },
      { src: "assets/upcellro-grid-4.jpg", caption: "UPCELLRO® — content grid 4" }
    ],
    links: [
  ...
  /* ---------- MEDICAL ---------- */
  {
    ...
    figures: [
      ...
      { src: "assets/dermatopia-grid-3.jpg", caption: "Dermatopia — content grid 3" },
      { src: "assets/dermatopia-grid-4.jpg", caption: "Dermatopia — content grid 4" }
    ],
...

  {
    ...
    figures: [
      { src: "assets/arty-smile-grid-1.jpg", caption: "Arty Smile — content grid 1" },
      { src: "assets/arty-smile-grid-2.jpg", caption: "Arty Smile — content grid 2" },
      { src: "assets/arty-smile-grid-3.jpg", caption: "Arty Smile — content grid 3" },
      { src: "assets/arty-smile-grid-4.jpg", caption: "Arty Smile — content grid 4" }
    ],
    ...
    linkGroups: [
      {
        title: "Reels",
        links: [
          { label: "Reel 01", url: "https://www.instagram.com/reel/DGqEiFHs2K_/" },
          { label: "Reel 02", url: "https://www.instagram.com/reel/DGIw8W9skdh/" }
        ]
      },
      {
        title: "Posts",
        links: [
          { label: "Post 01", url: "https://www.instagram.com/p/DFvYYYasFJm/" },
          { label: "Post 02", url: "https://www.instagram.com/p/DFsiXfVPVJO/" }
        ]
      }
    ],
    figures: [
      { src: "assets/alia-hijab-grid-1.jpg", caption: "Alia Hijab — content grid 1" },
      { src: "assets/alia-hijab-grid-2.jpg", caption: "Alia Hijab — content grid 2" },
      { src: "assets/alia-hijab-grid-3.jpg", caption: "Alia Hijab — content grid 3" },
      { src: "assets/alia-hijab-grid-4.jpg", caption: "Alia Hijab — content grid 4" }
    ],
  ...
  /* ---------- RETAIL ---------- */
  {
    ...
    figures: [
      { src: "assets/el-shazly-grid-1.jpg", caption: "El Shazly Stationery — content grid 1" },
      { src: "assets/el-shazly-grid-2.jpg", caption: "El Shazly Stationery — content grid 2" },
      { src: "assets/el-shazly-grid-3.jpg", caption: "El Shazly Stationery — content grid 3" },
      { src: "assets/el-shazly-grid-4.jpg", caption: "El Shazly Stationery — content grid 4" }
    ],
  ...
  /* ---------- AGENCY ---------- */
  {
    ...
    figures: [
      { src: "assets/run-agency-grid-1.jpg", caption: "Run Agency — content grid 1" },
      { src: "assets/run-agency-grid-2.jpg", caption: "Run Agency — content grid 2" },
      { src: "assets/run-agency-grid-3.jpg", caption: "Run Agency — content grid 3" },
      { src: "assets/run-agency-grid-4.jpg", caption: "Run Agency — content grid 4" }
    ],
